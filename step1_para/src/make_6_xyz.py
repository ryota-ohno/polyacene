...
def make_gjf_xyz(auto_dir,monomer_name,params_dict,isInterlayer):
    ...
    monomer_array_i = get_monomer_xyzR(monomer_name,0,0,0,A1,A2,A3, phi1)
    if a_ > b_:
        monomer_array_p1 = get_monomer_xyzR(monomer_name,0,b_,Rp,A1,A2,A3, phi1)##p1がb方向
    else:
        monomer_array_p1 = get_monomer_xyzR(monomer_name,a_,0,2*Rt-Rp,A1,A2,A3, phi1)##p2がa方向
    ...
    monomer_array_t1 = get_monomer_xyzR(monomer_name,a_/2,b_/2,Rt,-A1,A2,-A3, phi2)
    monomer_array_t2 = get_monomer_xyzR(monomer_name,a_/2,-b_/2,Rt-Rp,-A1,A2,-A3, phi2)
    monomer_array_t3 = get_monomer_xyzR(monomer_name,-a_/2,-b_/2,-Rt,-A1,A2,-A3, phi2)
    monomer_array_t4 = get_monomer_xyzR(monomer_name,-a_/2,b_/2,Rp-Rt,-A1,A2,-A3, phi2)
