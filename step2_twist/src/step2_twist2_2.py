...
def init_process(args):
    ...
    def get_init_para_csv(auto_dir,monomer_name):
        ...
        init_para_list = []
        A1_list =[-14,-12,-10,-8,-6,-4,-2,0]; A2_list = [34]
...
#         d = 5.5
        if monomer_name=='naphthalene':
            n=2
        elif monomer_name=='anthracene':
            n=3
        elif monomer_name=='tetracene':
            n=4
        elif monomer_name=='pentacene':
            n=5
        elif monomer_name=='hexacene':
            n=6
        for a_,b_,theta in step1_para_zip:
            ...
            for A1 in tqdm(A1_list):
                for A2 in A2_list:
                    ...
                    b = b + 4.8 * (n-1) * abs(np.sin(np.radians(A1))) / np.tan(np.radians(theta))
